  ...
  return (
    <nav className="bg-[#EBECCc] px-4 py-6 shadow-md">
      <div className="mx-auto flex items-center justify-between">
        ...
        {/* Login */}
        {user && user?.email ? (
          <button onClick={handleLogOut} className="hidden md:block bg-[#95AA9B] text-lg text-white px-4 py-2 rounded-md font-medium border-2 border-amber-50 hover:bg-[#EC9C85]">
            Logout
          </button>
        ) : (
          <Link to="/login">
